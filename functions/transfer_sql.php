<?php
    ...
    $transfer_2_sql = <<<DOC_SQL
SELECT id1,id2,id3,f_time1,f_time2,f_time3,ADDTIME(f_time1,ADDTIME(f_time2,f_time3))  AS flight_time,transfer_time,total_price,depart_time,arrive_time FROM 
( 
...
AS TransferTable
ORDER BY total_price,depart_time,arrive_time,flight_time,transfer_time -- 排序：價格 飛行時間 轉機時間
